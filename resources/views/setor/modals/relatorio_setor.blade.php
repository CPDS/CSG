...
<div id="relatorio_setor-modal" class="modal fade bs-example" role="dialog" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{route('gerenciar-setores.relatorio') }}" target="_blank" method="post" class="form-horizontal" role="form" id="form" >
           {{ csrf_field() }}
